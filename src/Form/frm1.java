...
public class frm1 extends javax.swing.JFrame {
    ...
    private void CariData(){
        try {
            ...
            String sql = "SELECT * FROM calon WHERE nama LIKE '%"+tCari.getText()+"%'";
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Cari Nama Calon Siswa");
        ...
        jLabel5.setText("DATA CALON SISWA");
        ...
        int jawab = JOptionPane.showConfirmDialog(null, "Apakah yakin menyimpan data?","Konfirmasi",JOptionPane.YES_NO_OPTION);
            ...
            try {
                ...
                if (bTambah.isEnabled()) {
                    //cek nik
                    String ceknik = "SELECT * FROM calon WHERE nik='"+t1.getText()+"'";
                    rs = st.executeQuery(ceknik);
                    if (rs.next()) {
                        JOptionPane.showMessageDialog(null, "Maaf nik sudah ada");                    
                    } else {
                        //insert                     
                        String sql = "INSERT INTO calon (nik,nama,alamat) VALUES ('"+t1.getText()+
                                 "','"+t2.getText()+
                                 "','"+t3.getText()+"')";
                     ...
                     //update                     
                    String sql = "UPDATE calon SET nama = '"+t2.getText()+
                            "', alamat = '"+t3.getText()+
    ...
    private void bHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bHapusActionPerformed
        ...
        if (t1.getText().equals("")) {
            ...
            int jawab = JOptionPane.showConfirmDialog(null, "Apakah yakin data calon siswa nik "+t1.getText()+" akan dihapus?","Konfirmasi",JOptionPane.YES_NO_OPTION);
            if (jawab==0) {
                try {
                    st = kon.createStatement();
                    String hapus = "DELETE FROM calon WHERE nik='"+t1.getText()+"'";
                    st.execute(hapus);
                    JOptionPane.showMessageDialog(null, "Data calon siswa nik "+t1.getText()+" berhasil dihapus");
                    Bersih();
                    TampilData();                                                
                } catch (Exception e) {
    ...
    private void bCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCetakActionPerformed
        // TODO add your handling code here:
        MessageFormat header = new MessageFormat("Laporan Data Calon Siswa");
